    ...
    <div className="min-h-screen bg-cream-100 pt-24 pb-16">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="font-heading text-lg text-charcoal-600 max-w-2xl mx-auto">
        ...
        <div className="prose prose-lg max-w-none">
          <div className="bg-white rounded-crown p-8 shadow-soft mb-8">
            <h2 className="font-display text-3xl tracking-wide text-charcoal-900 mb-4">
              BORN FROM A LOVE OF THE GAME
            </h2>
            <p className="font-heading text-charcoal-600 mb-4">
            ...
            <p className="font-heading text-charcoal-600">
              Our custom 3D-printed pickleball crowns and laser-engraved wooden medals are designed to celebrate your victories in style.
              Each product is crafted with care, creating one-of-a-kind trophies that are both playful and prize-worthy.
            </p>
          </div>
        ...
        <div className="text-center">
          <h2 className="font-display text-3xl md:text-4xl tracking-wide text-charcoal-900 mb-4">
            READY TO CROWN A CHAMPION?
          </h2>
          <p className="font-heading text-charcoal-600 mb-6">
            Design your custom pickleball crown or medal today.
          </p>
